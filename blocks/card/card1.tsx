...
const LogoContainer = styled.div`
  ...
  > i {
    ...
    font-size: 4rem;
    color: var(--logoColor);
    background: -moz-linear-gradient(top, #222650 0%, #08caeb 100%);
    background: -webkit-linear-gradient(top, #222650 0%, #08caeb 100%);
    background: linear-gradient(to bottom, #222650 0%, #08caeb 100%);
