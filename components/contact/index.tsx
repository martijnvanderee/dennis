  ...
  <S>
    <Container>
      ...
      <ContentContainer>
        <Form />
        <ContactInformation>
          <Button logo="call" text="06-12027229" />
          <Button logo="email" text="IkBenEenLekkerding@gmail.com" />
          <Telefoon>
...
type Props1 = { text: string; logo: string };

export const Button: React.FunctionComponent<Props1> = ({ text, logo }) => (
  <Telefoon>
